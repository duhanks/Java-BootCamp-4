...
public class QFIKPSPublicSoap
{
    ...
    public QFIKPSPublicSoap(){}

    public QFIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QFIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QFIExtendedSoapSerializationEnvelope envelope= new QFIExtendedSoapSerializationEnvelope(QFIExtendedSoapSerializationEnvelope.VER11);
