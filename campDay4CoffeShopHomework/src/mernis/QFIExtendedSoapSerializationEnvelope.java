...
public class QFIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(QFIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new QFIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static QFIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static QFIDateTimeConverter dateTimeConverter = new QFIStandardDateTimeConverter();

    public QFIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public QFIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new QFIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=QFIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,QFIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=QFIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
